...
public class SeleccionarPrestadorFragment extends Fragment {
    ...
    private SeleccionarPrestadorViewModel mViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_seleccionar_prestador, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        mViewModel = ViewModelProviders.of(this).get(SeleccionarPrestadorViewModel.class);
